...
<template>
    <Head title="Nueva Necesidad de Donación - Administración" />
    ...
    <AdminLayout>
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                ...
                <h1 class="text-3xl font-bold text-gray-900">Nueva Necesidad de Donación</h1>
                <p class="mt-2 text-gray-600">
                    Agrega una necesidad de donación para que los donantes sepan qué se requiere
                </p>
            </div>
                ...
                <form @submit.prevent="submit" class="p-6 space-y-6">
                    ...
                    <div class="flex items-center justify-end space-x-3 pt-4 border-t border-gray-200">
                        ...
                        >
                            ...
                            <span v-else>Crear Necesidad</span>
                        </button>
                    </div>
                </form>
            </div>
