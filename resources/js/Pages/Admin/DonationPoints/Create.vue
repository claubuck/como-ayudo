...
const submit = () => {
    form.post(route('admin.donation-points.store'));
};
</script>

<template>
    <Head title="Nuevo Punto de Recepción - Administración" />
    ...
    <AdminLayout>
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                ...
                <h1 class="text-3xl font-bold text-gray-900">Nuevo Punto de Recepción</h1>
                <p class="mt-2 text-gray-600">
                    Agrega un nuevo punto donde se reciben donaciones
                </p>
            </div>
