...
const form = useForm({
    ...
    order: props.zone.order,
});

const submit = () => {
    form.put(route('admin.zones.update', props.zone.id));
};
</script>

<template>
    <Head title="Editar Zona - Administración" />
    ...
    <AdminLayout>
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                ...
                <h1 class="text-3xl font-bold text-gray-900">Editar Zona</h1>
                <p class="mt-2 text-gray-600">
                    Modifica la información de la zona afectada
                </p>
            </div>
