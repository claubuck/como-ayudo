            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
                <div class="text-center max-w-3xl mx-auto">
                    ...
                    <div class="flex flex-wrap items-center justify-center gap-3 mt-8">
                        <span class="text-blue-200 text-sm font-medium">Comparte esta plataforma:</span>
                        <button
                            @click="shareOnFacebook"
                            class="inline-flex items-center px-4 py-2 bg-white/10 hover:bg-white/20 text-white rounded-lg font-medium transition-colors backdrop-blur-sm border border-white/20"
